...
exports.LanguageIdentifier = void 0;
class LanguageIdentifier {
    identify(text, defaultLang, recognizedLangs = ['en', 'zh-cn', 'zh-tw']) {
...
LanguageIdentifier.LATIN_THRESHOLD = 0.70;
...
LanguageIdentifier.SIMPLIFIED_CHARS = new Set("体书风长门东华乐");
// TC Forms (e.g., '體' vs '体', '國' vs '国', '書' vs '书')
LanguageIdentifier.TRADITIONAL_CHARS = new Set("體書風長門東華樂");
